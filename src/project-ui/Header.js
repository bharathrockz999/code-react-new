...
import icon from './assets/nwmsu_logo.png'
                        ...
                        <nav className="navbar navbar-default" role="navigation">
                            <div className="navbar-header">
                                <a className="logo" href="#">
                                    <img className="img-responsive logo" style={{ "height": "auto", "width": "180px", "margin-right": "10px" }} src={icon} alt="" data-logo-alt={icon} />
                                </a>                               
                            </div>
                            <div>
                            <span className="logo-title" style={{ "font-size": "1.5rem", "margin-left": "auto" }}>Professional Based Learning</span>
                            </div>
